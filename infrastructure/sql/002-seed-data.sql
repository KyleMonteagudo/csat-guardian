-- =============================================================================
-- CSAT Guardian - Seed Data (Test Cases)
-- =============================================================================
-- Run AFTER schema-complete.sql:
--   sqlcmd -S sql-csatguardian-dev.database.windows.net -d sqldb-csatguardian-dev -U sqladmin -P 'YourPassword' -i 002-seed-data.sql
--
-- Test Cases:
--   case-001: Happy customer (ideal behavior, no violations)
...
('mgr-001', 'David Rodriguez', 'drodriguez@microsoft.com', 'CSS Azure Core', NULL),
('eng-001', 'Kevin Monteagudo', 'kmonteagudo@microsoft.com', 'CSS Azure Core', 'mgr-001'),
('eng-002', 'Sarah Chen', 'schen@microsoft.com', 'CSS Azure Core', 'mgr-001'),
('eng-003', 'Marcus Williams', 'mwilliams@microsoft.com', 'CSS M365', 'mgr-001');
GO
...
-- =============================================================================
-- CASE 1: HAPPY CUSTOMER - Ideal behavior, no violations
...
-- =============================================================================
-- CASE 2: FRUSTRATED CUSTOMER - CSAT risk, escalation language
-- Engineer: Kevin | Customer: Fabrikam Manufacturing
-- 2-day rule violated, declining sentiment
-- =============================================================================
INSERT INTO cases (id, title, description, status, priority, owner_id, customer_id, created_on, modified_on)
VALUES (
    'case-002',
...
-- =============================================================================
-- CASE 5: 2-DAY RULE VIOLATION - Last outbound 3 days ago
...
-- =============================================================================
-- CASE 8: COMPLEX THIRD-PARTY - Blocked on external dependency
...
PRINT '';
PRINT 'Summary:';
SELECT 'Engineers' as TableName, COUNT(*) as RecordCount FROM engineers
UNION ALL SELECT 'Customers', COUNT(*) FROM customers
UNION ALL SELECT 'Cases', COUNT(*) FROM cases
UNION ALL SELECT 'Timeline Entries', COUNT(*) FROM timeline_entries;
GO
